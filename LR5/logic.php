...
function create_user($mail,$password,$name,$blood_type,$rh_factor,$vk_link,$gender,$date_of_birth,$interes,$adress,$linc){
    ...
    $mail = $linc->real_escape_string($mail);
    $password = $linc->real_escape_string($password);
    $name = $linc->real_escape_string($name);
    $vk_link = $linc->real_escape_string($vk_link);
    $interes = $linc->real_escape_string($interes);
    $adress = $linc->real_escape_string($adress);
